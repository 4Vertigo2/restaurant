...
$sql_update_customer = "Update CUSTOMER_TBL set CUSTOMER_FIRST_NAME='".$user_first_name."', CUSTOMER_SURNAME='".$user_surname."', CUSTOMER_PHONE_NUMBER='".$user_phone_number."' where CUSTOMER_ID ='".$user_id."'";

if($link->query($sql_update_customer) === TRUE){
    echo "S1";
}
else{
    echo "S0";
